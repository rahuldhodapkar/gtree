...
# ===== gtreerun.sh 
#
# simple test script to run for setting up a basic gtree alignment with the
# material provided in the git repository.
#
# note that a compiled "gtree" binary must be visible in your system PATH
#
...
# single
gtree -x ix/lambda_virus -U reads/reads_1.fq \
